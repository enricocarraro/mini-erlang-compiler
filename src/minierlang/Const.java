...
public class Const {
    ...
    public static final String BIF_IS_ATOM = "@BIF_is_atom_1";
    public static final String BIF_IS_BOOLEAN = "@BIF_is_boolean_1";
    public static final String BIF_IS_FLOAT = "@BIF_is_float_1";
    public static final String BIF_IS_INTEGER = "@BIF_is_integer_1";
    public static final String BIF_IS_FUNCTION = "@BIF_is_function_1";
    public static final String BIF_IS_LIST = "@BIF_is_list_1";
    public static final String BIF_IS_NUMBER = "@BIF_is_number_1";
    public static final String BIF_ABS = "@BIF_abs_1";
    public static final String BIF_FLOAT = "@BIF_float_1";
    public static final String BIF_HD = "@BIF_hd_1";
    public static final String BIF_TL = "@BIF_tl_1";
    public static final String BIF_LENGTH = "@BIF_length_1";
    public static final String BIF_ROUND = "@BIF_round_1";
    public static final String BIF_TRUNC = "@BIF_trunc_1";
